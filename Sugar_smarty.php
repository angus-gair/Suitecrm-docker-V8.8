...
class Sugar_Smarty extends Smarty
{
    ...
    public function __construct()
    {
        ...
        //TODO fix literals
            // Then register the modifiers:
        $this->registerPlugin('modifier', 'strval', 'strval'); # line added 
        $this->registerPlugin('modifier', 'is_string', 'is_string');  # line added 
        $this->registerPlugin('modifier', 'count', 'count'); # line added 
        $this->registerPlugin('modifier', 'strpos', 'strpos'); # line added 
